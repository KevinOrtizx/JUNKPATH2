...
CREATE TABLE `componente` (
  ...
  `nom_componenete` varchar(30) DEFAULT NULL,
...
INSERT INTO `componente` (`cod_componente`, `nom_componenete`) VALUES ('001','sistemas de informacion'),('002','ingenieria de computacion'),('003','comun a sistemas y computacion'),('004','profundizacion-electivo'),('005','opcion de grado'),('006','nucleo comun ingenieril'),('007','matematicas-fisica');
